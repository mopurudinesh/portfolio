...
const experiences = [
  {
    ...
    location: 'Remote',
    description:
      'Built an AI-based Spam News Detection system using Python and Google Colab, achieving ~88% accuracy and performing end-to-end data pipeline development.',
    achievements: [
      'Built an AI-based Spam News Detection system using Python, Google colab with ~88% accuracy.',
      'Performed data collection, cleaning, preprocessing, and feature engineering on 1,000+ records.',
      'Applied statistical analysis and model evaluation metrics (accuracy, precision, recall, F1-score).',
      'Collaborated in end-to-end ML lifecycle and data pipeline development, version control using GitHub.',
    ],
    technologies: [
      'Python',
      'Google Colab',
