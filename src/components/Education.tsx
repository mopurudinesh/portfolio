...
const educationData = [
  {
    ...
    period: '2022 - 2026',
    logo: 'SSE',
    description: 'Current undergraduate degree focusing on software development, data structures, and computer science fundamentals. CGPA - 8.00.',
    learnings: [
  ...
  },
  {
    ...
    period: '2020 - 2022',
    logo: 'SC',
    description: 'Pre-university education focusing on Mathematics, Physics, and Chemistry. Percentage - 81.6%.',
    learnings: [
