...
const projects = [
  {
    ...
    description: 'A responsive, modern portfolio website built with React, Vite, and Tailwind CSS. Features smooth animations and interactive UI components to showcase projects and experience.',
  ...
  },
  {
    ...
    description: 'Evaluated multiple Deep Learning architectures and Models for pest detection, achieving 85.86% accuracy. Validated results using statistical testing and optimized preprocessing pipelines to reduce manual classification effort.',
